// To parse this data:
//
//   import { Convert, ResultadoBusquedaGIF } from "./file";
//
//   const resultadoBusquedaGIF = Convert.toResultadoBusquedaGIF(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface ResultadoBusquedaGIF {
    data:       Gif[];
...
export class Convert {
    public static toResultadoBusquedaGIF(json: string): ResultadoBusquedaGIF {
        return cast(JSON.parse(json), r("ResultadoBusquedaGIF"));
    }

    public static resultadoBusquedaGIFToJson(value: ResultadoBusquedaGIF): string {
        return JSON.stringify(uncast(value, r("ResultadoBusquedaGIF")), null, 2);
    }
}
